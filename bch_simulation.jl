...
# ╔═╡ 39caddd0-b94d-11ef-3680-0b6dc57b7384
begin
	using Random
	using Distributions
	using Gadfly
...
# ╔═╡ 1418740f-c9de-43d6-8acf-3a3ff3851dcb
module bachlib 
	include("julia_code/bach.jl")
end

# ╔═╡ 1cd93580-41d1-4afb-b424-d361dcc945bd
function number_sequence(i)
	1 / 2^i
end

# ╔═╡ fc998f5d-1ac0-402e-8c98-4bb70c583a10
...
# ╔═╡ 7637e2c6-578f-4f00-97a3-f13513377245
md"""
Perform BACH optimization with input values for enrollemnt
"""

# ╔═╡ 30b7192b-0d97-44b5-8a60-2bf9f69010de
enrolled = bachlib.bach(data, n, m, number_sequence) 

# ╔═╡ 6333483e-d9d6-4a96-830f-16376de85f0d
md"""
Extract helper data bits
"""

# ╔═╡ 06870e05-4517-4264-b3c7-2c8c0bb008d6
helperdata = map(v -> v.helperdatabits, enrolled[1])

# ╔═╡ 79775729-c456-4e09-9705-6741d78cca4c


# ╔═╡ c23d37eb-a524-4625-ae12-32fe9c023e30
bachlib.reconstruct_weights(m, number_sequence)
...
manifest_format = "2.0"
project_hash = "185b32b192f705f02e26e065c4007bc07d31b7e8"
